...
@section('meta-description', 'Strucko - Privacy Policy')

@section('title', 'Strucko - Privacy Policy')
...
<article>
    ...
    <p>
        ...
        They're used for many things, such as remembering whether you've visited 
        ...
        about the use of your computer but don't include personal information 
        about you (they don't store your name, for instance).
        <br>
    ...
    <p>
        ...
        You can choose, below, not to allow cookies. If you do, we can't guarantee 
    ...
    <p>
        ...
        We don't list every single cookie used by name - but for each type of
        ...
        These cookies hold information about the computer - they don't hold 
        personal information about you (ie it's not linked to you as an individual).
        But they might hold a record of what other websites you've looked at - 
        so we could show you a car advert if you've previously visited a motoring website.
        ...
        logged in (to ensure you don't see comments you've reported as abusive, for
